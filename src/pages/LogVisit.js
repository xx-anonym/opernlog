...
export function LogVisitPage(params = {}) {
    ...
    <div class="page-header">
      <h1 class="page-header__title">✨ Besuch loggen</h1>
      <p class="page-header__subtitle">Halte deinen Opernbesuch fest</p>
    </div>
    ...
    <form class="log-form" id="logForm">
      ...
      <div class="form-group">
        ...
        <input type="date" class="input" id="visitDate" value="${new Date().toISOString().split('T')[0]}" />
      </div>
      ...
      <div class="form-group">
        ...
        <textarea class="input textarea" id="reviewText" rows="4" placeholder="Wie war die Vorstellung? Was hat dir gefallen? Was nicht?"></textarea>
      </div>
      
      <div class="form-actions">
        <button type="submit" class="btn btn--primary btn--lg">Besuch speichern</button>
  ...
  `;
    ...
    const starWidget = StarRating(0, true, (rating) => { selectedRating = rating; }, 'lg');
